    ...
    extends SVGBase
{
    ...
    public SVGEllipse(Element element)
    {
        ...
        rx = Double.parseDouble(element.getAttributeValue("rx"));
        ry = Double.parseDouble(element.getAttributeValue("ry"));
    }
    ...
    public String myOneFunction()
    {
        ...
        rval.append("rval.arcTo(new RectF("+(cx-rx)+"f, "+(cy-ry)+"f, " +(cx+rx)+"f, " + (cy +ry)+"f), 180, 180);\n");
